    ...
    <div className="space-y-8">
      ...
      <div className="text-center py-12">
        <h1 className="text-4xl font-bold tracking-tight mb-4">
          Welcome to <span className="text-primary">PromptFlow</span>
        </h1>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <Link href="/configure" className="group">
          <div className="bg-card rounded-xl border p-6 transition-all hover:shadow-lg hover:border-primary/50">
        ...
        <Link href="/input" className="group">
          <div className="bg-card rounded-xl border p-6 transition-all hover:shadow-lg hover:border-green-500/50">
        ...
        <Link href="/output" className="group">
          <div className="bg-card rounded-xl border p-6 transition-all hover:shadow-lg hover:border-purple-500/50">
        ...
        <div className="p-6">
          {isLoading ? (
            ...
            <div className="flex flex-col items-center justify-center py-12 text-center">
              ...
              <Link 
                href="/configure"
                className="inline-flex items-center justify-center rounded-lg bg-primary px-4 py-2.5 text-sm font-medium text-primary-foreground shadow-sm transition-colors hover:bg-primary/90"
              >
